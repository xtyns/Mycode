function [x,fval,exitflag]=Branch(f,A,b,Aeq,beq,lb,ub,code)
...
%下分支
[x1,fval1,exitflag1]=Branch(f,A,b,Aeq,beq,lb,ub0,[code,'0']);

%上分支
[x2,fval2,exitflag2]=Branch(f,A,b,Aeq,beq,lb0,ub,[code,'1']);
